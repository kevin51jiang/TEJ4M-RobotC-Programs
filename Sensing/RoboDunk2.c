...
////////////////////////////////////
task main() {
	// constants of what the potentiometer should read if the amotLeft is at a certain position
	const int DIAGONAL = 2100,
						ALLDOWN = 4095;

	// move forward until the robot is within amotLefts length of the ball
	forwardUntilSmallEnough(motRight, motLeft, sonar, 9);
	...
	wait1Msec(1000);
	setMotorToPos(motArm, amotLeftPot, ALLDOWN); // drop the amotLeft to allow the ball to roll off into the hoop
